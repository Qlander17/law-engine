...
The statutory text under `library/source/` and `library/normalized/` — currently the Commonwealth of Virginia's enacted Uniform Commercial Code, Title 8.2 (Article 2) and Title 8.9A (Article 9) — is **public-domain government material**, not an original work of this project, and is not covered by the Apache License, Version 2.0 above.
